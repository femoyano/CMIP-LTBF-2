...
r_md0, f_ug, f_ge, r_mr= (sy.symbols('r_md0 f_ug f_ge r_mr'))
...
r_md0_v = T_resp_eq(r_md0_ref, T, T_ref, E_m, R)
...
eq_C_P = sol_C_P.subs([
    ...
    (M, M_v), (mc, mc_v), (M_fc, M_fc), (r_md0, r_md0_v),
